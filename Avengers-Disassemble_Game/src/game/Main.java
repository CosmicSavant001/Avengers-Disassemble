...
/**
 * Entry point - launches the Start Screen first.
 * Flow: StartScreen -> MainMenu -> CharacterSelect -> BattleScreen -> GameOverScreen
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            StartScreen start = new StartScreen(leaderboard);
